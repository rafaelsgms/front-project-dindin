...
export default function ModalEdtRegistro({ modalIsOpen, handleCloseModal, loadTransactions, editRecord, transactions }) {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const response = await api.put(`/transacao/${transactions.id}`, dataTransaction, {
                headers: {
